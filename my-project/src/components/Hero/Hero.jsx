  ...
  return (
    ...
    min-h-[650px] relative">
        ...
        <div className=" flex flex-col  justify-center py-14 md:pr-16 xl:pr-40 md:py-0 ">
            <div className="text-center md:text-left space-y-6">
               <motion.p 
                ...
                initial="hidden"
                animate="visible"
               className="text-orange-600 uppercase font-semibold">100% Satisfication Guarantee</motion.p>
               <motion.h1
                ...
                className="flex gap-8 justify-center md:justify-start !mt-8 items-center">
                   ...
                   <button className="flex justify-end items-center gap-2 font-semibold">
                    <span className="w-10 h-10 bg-secondary/15 rounded-full flex justify-center items-center">
                        <FaPlay className="text-secondary"/></span>See how it works</button>
                </motion.div>
            </div>
        </div>
        {/* hero image  */}
        <div className="flex justify-center items-center">
            ...
            src={HeroImg} alt="hero" className="w-[350px] md:w-[550px] xl:w-[900px]"/>
        </div>
    </div>
    </>
  )
